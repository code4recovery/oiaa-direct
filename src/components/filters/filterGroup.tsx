...
export function renderFilterGroups({
  ...
  const categories = [
    ...
    },
    {
      key: "formats",
      title: "Formats",
      options: facetOptions.FORMATS as Record<Format, string | string[]>,
    ...
    },
    {
      key: "features",
      title: "Features",
      options: facetOptions.FEATURES as Record<Feature, string | string[]>,
    ...
    },
    {
      key: "communities",
      title: "Communities",
      options: facetOptions.COMMUNITIES as Record<Community, string | string[]>,
    ...
    },
    {
      key: "languages",
      title: "Languages",
      options: facetOptions.LANGUAGES as Record<Language, string | string[]>,
