...
export function Filter({
  ...
  const { open: isTimeOpen, onToggle: onTimeToggle } = useDisclosure({
    defaultOpen: false,
  })
  const { open: isTypesOpen, onToggle: onTypesToggle } = useDisclosure({
    defaultOpen: false,
  })
  const { open: isFormatsOpen, onToggle: onFormatsToggle } = useDisclosure({
    defaultOpen: false,
  })
  const { open: isFeaturesOpen, onToggle: onFeaturesToggle } = useDisclosure({
    defaultOpen: false,
  })
  const { open: isCommunitiesOpen, onToggle: onCommunitiesToggle } =
    useDisclosure({ defaultOpen: false })
  const { open: isLanguagesOpen, onToggle: onLanguagesToggle } = useDisclosure({
    defaultOpen: false,
  })
